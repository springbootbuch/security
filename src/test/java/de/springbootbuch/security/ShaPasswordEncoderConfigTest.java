...
@ActiveProfiles("use-sha256-password-hash")
public class ShaPasswordEncoderConfigTest {
	...
	public void userDetailsShouldWork() {
		...
		headers.add("Authorization", "Basic " + Base64.getEncoder().encodeToString("Michael:sha".getBytes()));
